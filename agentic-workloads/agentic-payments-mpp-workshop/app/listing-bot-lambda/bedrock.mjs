/**
 * Bedrock Converse — the listing generator.
 *
 * Sonnet 4.6 (default: global.anthropic.claude-sonnet-4-6) with a
 * platform-aware system prompt. Returns a parsed JSON listing.
 *
 * TODO 3 (participant) lives here: wire the ConverseCommand call. The stubbed
 * overlay version exposes the model/prompt/messages and asks participants
 * to paste the SDK call.
 */
